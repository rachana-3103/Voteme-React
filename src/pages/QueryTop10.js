...
const QueryTop10 = () => {
    ...
    const loadQuery = async () => {
        const query = await axios.get(`http://localhost:8080/voteme/query?searchBy=3`, { headers: userInfo.header })
            ...
            <div className="my-queries">
                <div className="query-tabing">
                    <div className="tab-listing">
                        ...
                        <div className="small-title" style={{ textAlign: "center" }}><h4>Top10 Queries</h4></div>
