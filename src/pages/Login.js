...
const Login = () => {
    ...
    const signup = (res) => {
        ...
        axios.post('http://localhost:8080/voteme/signup', googleresponse)
            .then((result) => {
            ...
            <section className="login-page">
                <div className="login-block">
                    ...
                    <div className="login-btn-group">
                        <GoogleLogin
                            clientId="1002890881980-sf104uj4ah64qh41deu6s37cb06gaec3.apps.googleusercontent.com"
                            ...
                            render={
                                (renderProps) => (
                                    <span className="login-with-google" onClick={renderProps.onClick} disabled={renderProps.disabled}><a href='/home'><img src="assets/images/google.svg" alt="" /> Login With Google</a></span>
                                )}
                        />
